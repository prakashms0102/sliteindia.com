               ...
               <div class="row align-items-center">
                  <div class="col-lg-12 col-md-12">
                     <div class="tp-header-welcome">
                        <p class="text-center">Welcome to S-lite India </p>
                     </div>
                  </div>
               </div>
            </div>
                           ...
                           <div class="tp-header-search-wrapper d-flex align-items-center">
                              ...
                              <div class="tp-header-search-category">
                                 <select>
                                    ...
                                    <option>17 Inch LED TV</option>
                                    <option>19 Inch LED TV</option>
                                    <option>21 Inch LED TV</option>
                                    <option>22 Inch LED TV</option>
                                    <option value="">24 Inch LED TV</option>
                                    <option value="">26 Inch LED TV</option>
                                 </select>
                              </div>
                  ...
                  <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                     <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                        <div class="tp-header-login d-none d-lg-block">
                           <a href="#" class="d-flex align-items-center">
                              <div class="tp-header-login-icon">
                                 <span>
                                    <img src="assets/img/icon/svg/house-green.svg" height="30" />
                                 </span>
                              </div>
                              <div class="tp-header-login-content d-none d-xl-block">
                                 <span>Visit Here</span>
                                 <h5 class="tp-header-login-title">Branches</h5>
                              </div>
                           </a>
                        </div>
                        <div class="tp-header-action d-flex align-items-center ml-50">
                           ...
                           <div class="tp-header-action-item d-none d-lg-block">
                              <a href="#" class="tp-header-action-btn" title="All Products">
                                 <img src="assets/img/icon/svg/shopping-cart.svg" height="35" />
                              </a>
                           </div>

                           <div class="tp-header-action-item d-none d-lg-block" title="Contact Now">
                              <a href="https://wa.me/+919934144217" target="_blank" class="tp-header-action-btn">
                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="40px" height="40px"
                                    fill-rule="evenodd" clip-rule="evenodd">
                                    <linearGradient id="k87TA_gnBJ8uBlK4qfs8ia" x1="6.718" x2="35.097" y1="12.801"
                                       y2="41.18" gradientUnits="userSpaceOnUse">
                                    ...
                                    <linearGradient id="k87TA_gnBJ8uBlK4qfs8ib" x1="15.389" x2="28.863" y1="10.726"
                                       y2="39.265" gradientUnits="userSpaceOnUse">
                              ...
                              <ul>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                       <li>
                                          <a class="mega-menu-title">Product Box</a>
                                          <ul>
                                             <li>
                                                <a href="18-inch-led-tv.php"><img src="assets/img/product/17-inch/17-inch-box.jpeg" alt=""></a>
                                             </li>
                                          </ul>
                                       </li>

                                       <li>
                                          <a class="mega-menu-title">Product</a>
                                          <ul>
                                             <li>
                                                <a href="18-inch-led-tv.php"><img src="assets/img/product/17-inch/17-inch.jpeg"
                                                      alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                       <li>
                                          <a class="mega-menu-title">Details</a>
                                          <table class="table">
                                             <tr>
                                                <th>Resolution : </th>
                                                <td>1366X720</td>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="19-inch-led-tv.php"><img src="assets/img/product/19-inch/box-s-lite-india.webp" alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                       ...
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="19-inch-led-tv.php"><img src="assets/img/product/19-inch/19-inch.jpeg"
                                                      alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="21-inch-led-tv.php"><img src="assets/img/product/20.5-inch/22 inch box.webp" alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                       ...
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="21-inch-led-tv.php"><img src="assets/img/product/20.5-inch/20.5-inch.jpeg"
                                                      alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="22-inch-led-tv.php"><img src="assets/img/product/22-inch/22 inch box.webp" alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                       ...
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="22-inch-led-tv.php"><img src="assets/img/product/22-inch/S-LIGHT-22-inch-tv.png"
                                                      alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="24-inch-led-tv.php"><img src="assets/img/product/24-inch/22 inch box.webp" alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                       ...
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="24-inch-led-tv.php"><img src="assets/img/product/24-inch/S-LIGHT-24-inch-tv.png"
                                                      alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="mega-menu tp-submenu">
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="26-inch-led-tv.php"><img src="assets/img/product/26-inch/22 inch box.webp" alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                                       ...
                                       <li>
                                          ...
                                          <ul>
                                             <li>
                                                <a href="26-inch-led-tv.php"><img src="assets/img/product/26-inch/S-LIGHT-26-inch-tv.png"
                                                      alt=""></a>
                                             </li>
                                          </ul>
                                       </li>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="main-menu menu-style-1">
                           <nav class="tp-main-menu-content">
                              <ul>
                                 <li class="ms-lg-3"><a href="#">Home</a></li>
                                 <li class="ms-lg-3"><a href="#">Shop</a></li>
                                 <li class="ms-lg-3"><a href="#">About Us</a></li>
                                 <li class="ms-lg-3"><a href="#">Contact Us</a></li>
                                 <li class="ms-lg-3"><a href="#">Branches</a></li>
                              </ul>
                           </nav>
                        </div>
                     </div>
                     <div class="col-xl-3 col-lg-3">
                        <div class="tp-header-contact d-flex align-items-center justify-content-end">
                           ...
                           <div class="tp-header-contact-content">
                              <h5>Hotline:</h5>
                              <p><a href="tel:+91 993-4144-217">+91 9934144217</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
