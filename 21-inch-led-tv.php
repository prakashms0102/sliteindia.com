                  ...
                  <div class="row">
                           ...
                           <nav>
                              <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                 <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                    <img src="assets/img/product/20.5-inch/20.5-inch.jpeg" alt="">
                                 </button>
                                 <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                    <img src="assets/img/product/20.5-inch/20.5-inch-back.webp" alt="">
                                 </button>
                                 ...
                                 <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                    <img src="assets/img/product/20.5-inch/22 inch box.webp" alt="">
                                 </button>
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <h3 class="tp-product-details-title">21 Inch LED Television</h3>
                           <p>Products Detail - HD, 80CMS Samsung Panel Inside, Grande Panel, 32 Class, 1080, Hdmi Connectivity Of Crystal Clear Digital Transmission, USB To USB Copy Function</p>
                           ...
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price">Rs. 15,000.00</span>
                              <span class="tp-product-details-price new-price">Rs. 9000.00</span>
                           </div>
                                       ...
                                       <div class="col-xl-10">
                                          <table>
                                             <tbody>
                                                ...
                                                <tr>
                                                   <td>Products Screen Size
                                                   </td>
                                                   <td>21inch</td>
                                                </tr>
                                                <tr>
                                                   <td>Display Tehnology</td>
                                                   <td>LED</td>
                                                </tr>
                                                <tr>
                                                   <td>Products Panel Material</td>
                                                   <td>PVC</td>
                                                </tr>
                                                <tr>
