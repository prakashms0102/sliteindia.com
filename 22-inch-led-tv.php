                  ...
                  <div class="row">
                           ...
                           <nav>
                              <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                 <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                    <img src="assets/img/product/22-inch/S-LIGHT-22-inch-tv.png" alt="">
                                 </button>
                                 <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                    <img src="assets/img/product/22-inch/20.5-inch-back.jpeg" alt="">
                                 </button>
                                 <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                                    <img src="assets/img/product/led-tv-side.webp" alt="">
                                 </button>
                                 <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                    <img src="assets/img/product/22-inch/22 inch box.webp" alt="">
                                 </button>
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <h3 class="tp-product-details-title">22 Inch LED Television</h3>
                           <p>This LED TV has a sleek and sturdy design that will complement the decor of any modern living room. The sleek and compact design makes it easy to mount. You can now access and enjoy the stunning quality of picture on the 22 inch LED display of this WEL-2200 HD Ready LED Television in astonishing 720p. The images are crisper and sharper, that will maximize your enjoyment. It will provide the perfect set up for your house. At the same time, the enhanced colour display and contrast will offer you the most vivid pictures.</p>
                           ...
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price">Rs. 16,000.00</span>
                              <span class="tp-product-details-price new-price">Rs. 9200.00</span>
                           </div>
   
                           

                           <div class="tp-product-details-action-wrapper"></div>
                              <a href="https://wa.me/+919934144217" target="_blank" class="tp-product-details-buy-now-btn w-100 text-center">Shop Now</a>
                           </div>
                           ...
                           <div class="tp-product-details-social py-3 ms-3">
                              <span>Share: </span>
                        ...
                        <div class="tp-product-details-tab-nav tp-tab">
                           <nav>
                              <div class="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                                ...
                                <button class="nav-link active" id="nav-addInfo-tab" data-bs-toggle="tab" data-bs-target="#nav-addInfo" type="button" role="tab" aria-controls="nav-addInfo" aria-selected="false">Product information</button>
                                       ...
                                       <div class="col-xl-10">
                                          <table>
                                             <tbody>
                                                ...
                                                <tr>
                                                   <td>YPrPb resolution</td>
                                                   <td>480i/p,576i/p, 720i/p,1080i/p</td>
                                                </tr>
                                                <tr>
                                                   <td>PC Resolution</td>
                                                   <td>UP to 1920×1080 60HZ</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>0.5W At 240VAC input & no load condition</td>
                                                </tr>
                                                <tr>
                                                   <td>Power Requirement</td>
                                                   <td>100-240 50/60Hz</td>
                                                </tr>
                                                <tr>
                                                   <td>Remote controller(English)</td>
                                                   <td>YES</td>
                                                </tr>
                                                <tr>
